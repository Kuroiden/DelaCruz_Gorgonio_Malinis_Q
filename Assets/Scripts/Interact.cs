...
public class Interact : MonoBehaviour
{
    ...
    public bool isNewEntryAdded = false;
    ...
    void Update()
    {
        ...
        {
            isNotebookActive = isNotebookActive ? false : true;
            notice.SetActive(false);
        }
        notebook.SetActive(isNotebookActive);
        mainUI.SetActive(!isNotebookActive);
        player.playerCanMove = isNotebookActive ? false : true;
    ...
    void OnTriggerStay()
    {
        if (!isChecked[setObjID]) this.GetComponent<Outline>().enabled = true;
